...
| Item | Status |
|---|---|
| I.1 `glDrawPixels` formats/types + PBO | [ ] |
| I.2 `glCopyPixels` `GL_DEPTH` / `GL_STENCIL` | [ ] |
| I.3 `glPolygonMode` independent front/back | [ ] |
| I.4 Feedback color/texture payloads | [ ] |
...
| **Total** | **95 entry points + 6 items** | **4 / 101** |
